...
const createDistributors = async () => {
  ...
  mydebugger(logourl);
  await client
    .query(`INSERT INTO distributors ( name, email, logourl, userid, password, accountid, location,phoneNumber)
    ...
    ('${name[4]}','${email}','${logourl[4]}', '${userid[4]}', '${hashedPassword}','${accountid[4]}','${location}','${phoneno}');`,
