...
exports.distrSignupMail = exports.sendBankGuaranteeStatus = exports.sendBankGuarantee = exports.sendATC = exports.sendOrderPlaced = exports.sendResetSuccessMail = exports.sendForgotPasswordMail = void 0;
...
const dir1 = path.join(__dirname, '../assets/BANK_GUARANTEE.pdf'); // const dir2 = path.join(__dirname, '../assets/AUTHORITY_TO_COLLECT.pdf');

const dataBuffer = fs.readFileSync(dir1).toString('base64'); // const dataBuffer2 = fs.readFileSync(dir2).toString('base64');

_mail.default.setApiKey(process.env.SENDGRID_API_KEY); // Configure the mail gen


const mailGenerator = new _mailgen.default({
  theme: 'cerberus',
  product: {
    name: projectName,
    link: url
...
const sendMail = ({
  ...
  _mail.default.send(mailOptions);
};
  ...
  const emailBody = {
    body: {
      ...
      action: {
        ...
        button: {
          color: '#1a82e2',
          text: 'View Order Summary' // link: `${url}/auth/activate_user?email=${email}&token=${token}`
...
exports.sendBankGuarantee = sendBankGuarantee;
...
exports.sendBankGuaranteeStatus = sendBankGuaranteeStatus;
...
exports.distrSignupMail = distrSignupMail;
...
exports.sendResetSuccessMail = sendResetSuccessMail;