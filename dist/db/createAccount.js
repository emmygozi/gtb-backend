...
const createAccount = async () => {
  ...
  await client.query(`INSERT INTO account ( accountno, accountname, bvn, accountbalance, averageinflow, averageoutflow, age, returnedchequecount, taxid, minmonthlodgement, minqtlodgement, classificationname, yearlyturnover)
    ...
    ('${accountno[6]}','${accountname[6]}', '${bvn[6]}', '${accountbalance[6]}','${averageinflow[6]}', '${averageoutflow[6]}','${age[6]}', '${returnedchequecount[6]}', '${taxid[6]}','${minmonthlodgement[6]}', '${minqtlodgement[6]}', '${classificationname[6]}', '${yearlyturnover[6]}');`, () => mydebugger({
    message: 'Created some accounts'
  }));
  client.release();
};
